...
OpcodeDef opcodes[] = {
    ...
    {   "get_item",     OpcodeDef::GetItem,                 2, 1 },
    {   "has_item",     OpcodeDef::HasItem,                 2, 1 },
    {   "get_size",     OpcodeDef::GetSize,                 1, 1 },
    {   "set_item",     OpcodeDef::SetItem,                 3, 0 },
    {   "del_item",     OpcodeDef::DelItem,                 2, 0 },
    {   "add_item",     OpcodeDef::AddItem,                 2, 0 },
    {   "typeof",       OpcodeDef::TypeOf,                  1, 1 },
    {   "astype",       OpcodeDef::AsType,                  2, 1 },
    {   "cmp",          OpcodeDef::Compare,                 2, 1 },
    {   "jmp",          OpcodeDef::Jump,                    1, 0 },
    {   "jeq",          OpcodeDef::JumpZero,                2, 0 },
    {   "jz",           OpcodeDef::JumpZero,                2, 0 },
    {   "jneq",         OpcodeDef::JumpNotZero,             2, 0 },
    {   "jnz",          OpcodeDef::JumpNotZero,             2, 0 },
    {   "jlt",          OpcodeDef::JumpLessThan,            2, 0 },
    {   "jlte",         OpcodeDef::JumpLessThanEqual,       2, 0 },
    {   "jgt",          OpcodeDef::JumpGreaterThan,         2, 0 },
    {   "jgte",         OpcodeDef::JumpGreaterThanEqual,    2, 0 },
