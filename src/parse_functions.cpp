...
OpcodeDef opcodes[] = {
    ...
    {   "mod",          OpcodeDef::Mod},
    {   "pow",          OpcodeDef::Pow},
    {   "left-shift",   OpcodeDef::BitLeft      },
    {   "right-shift",  OpcodeDef::BitRight     },
    {   "bitand",       OpcodeDef::BitAnd       },
    {   "bitor",        OpcodeDef::BitOr        },
    {   "bitxor",       OpcodeDef::BitXor       },
    {   "bitnot",       OpcodeDef::BitNot       },
    {   "random",       OpcodeDef::Random       },
    {   "inc",          OpcodeDef::Inc          },
    {   "dec",          OpcodeDef::Dec          },
    {   "get-random",   OpcodeDef::GetRandom    },
